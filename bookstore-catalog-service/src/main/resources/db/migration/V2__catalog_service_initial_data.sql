...
insert into PRODUCT (product_id, created_at, updated_at, available_item_count, product_description, price, product_name, product_category_id) values ('1', now(), now(), 345, 'Five Point Someone Book', 100, 'Five Point Someone', 'c6eec3f6-35f0-4a11-8dae-a859aa2b53d4');

insert into PRODUCT (product_id, created_at, updated_at, available_item_count, product_description, price, product_name, product_category_id) values ('2', now(), now(), 987, 'The White Tiger Book', 499, 'The White Tiger', 'c6eec3f6-35f0-4a11-8dae-a859aa2b53d4');

insert into PRODUCT (product_id, created_at, updated_at, available_item_count, product_description, price, product_name, product_category_id) values ('3', now(), now(), 872, 'Spring Framework Book', 399, 'Spring Framework', '8f825617-9522-4195-bfea-c396d9b966a0');

insert into PRODUCT (product_id, created_at, updated_at, available_item_count, product_description, price, product_name, product_category_id) values ('4', now(), now(), 678, 'Hibernate Basics Book', 299, 'Hibernate', '8f825617-9522-4195-bfea-c396d9b966a0');

insert into PRODUCT (product_id, created_at, updated_at, available_item_count, product_description, price, product_name, product_category_id) values ('5', now(), now(), 3545, 'Nun Book', 500, 'The Nun', '3925c6a6-351c-4067-b021-ced0e80988e4');

insert into PRODUCT (product_id, created_at, updated_at, available_item_count, product_description, price, product_name, product_category_id) values ('6', now(), now(), 0, 'Conjuring Book', 999, 'Conjuring', '3925c6a6-351c-4067-b021-ced0e80988e4');

insert into PRODUCT (product_id, created_at, updated_at, available_item_count, product_description, price, product_name, product_category_id) values ('7', now(), now(), 345, 'Five Point Someone Book', 100, 'Five Point Someone', 'c6eec3f6-35f0-4a11-8dae-a859aa2b53d4');

insert into PRODUCT (product_id, created_at, updated_at, available_item_count, product_description, price, product_name, product_category_id) values ('8', now(), now(), 987, 'The White Tiger Book', 499, 'The White Tiger', 'c6eec3f6-35f0-4a11-8dae-a859aa2b53d4');

insert into PRODUCT (product_id, created_at, updated_at, available_item_count, product_description, price, product_name, product_category_id) values ('9', now(), now(), 872, 'Spring Framework Book', 399, 'Spring Framework', '8f825617-9522-4195-bfea-c396d9b966a0');

insert into PRODUCT (product_id, created_at, updated_at, available_item_count, product_description, price, product_name, product_category_id) values ('10', now(), now(), 678, 'Hibernate Basics Book', 299, 'Hibernate', '8f825617-9522-4195-bfea-c396d9b966a0');

insert into PRODUCT (product_id, created_at, updated_at, available_item_count, product_description, price, product_name, product_category_id) values ('11', now(), now(), 3545, 'Nun Book', 500, 'The Nun', '3925c6a6-351c-4067-b021-ced0e80988e4');

insert into PRODUCT (product_id, created_at, updated_at, available_item_count, product_description, price, product_name, product_category_id) values ('12', now(), now(), 0, 'Conjuring Book', 999, 'Conjuring', '3925c6a6-351c-4067-b021-ced0e80988e4');
